...
The configuration file is named `config.json` and holds options about the API build process rather than the API itself.
...
|version
|When developing an API, update to the latest tooling version by checking the list here: https://github.com/tmforum-rand/oas-tooling/releases

2+h|**schemas**

|version
|Find the available schema collection versions here: https://github.com/tmforum-rand/oas-tooling/releases and update this value when working on a new version of an API
