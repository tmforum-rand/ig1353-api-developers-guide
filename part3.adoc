...
*In order to switch the previous tooling version (i.e v8.6.6, v8.6.5.. so on)*
...
3.Once the previous tooling version is running successfully, open the "Ports" tab, relaunch the web server/GUI, and perform your testing.
====
